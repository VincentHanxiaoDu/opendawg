...
### 1. Tool & Skill Preference (strict priority order)
...
### 2. Delegate & Parallelize — Protect Main Context
...
### 3. Memory — Continuously Learn and Recall
...
### 4. When You Don't Understand — STOP, Research, Then Act
